...
<script>
import Equipjz from '../../sys/basic/Equipjz'
import Equipcz from '../../sys/basic/Equipcz'
import Equipgl from '../../sys/basic/Equipgl'
import Equipjl from '../../sys/basic/Equipjl'
export default {
  name: "EquipMana",
  data() {
    return {
  ...
  methods: {
    ...
    UPDATE(){
      Equipjz.methods.initJls();
      Equipcz.methods.initJls();
      Equipgl.methods.initJls();
      Equipjl.methods.initJls();
    },
    deleteHandler(data) {
