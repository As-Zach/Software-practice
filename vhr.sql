...
-- ----------------------------
-- Table structure for baiduimagebed
-- ----------------------------
DROP TABLE IF EXISTS `baiduimagebed`;
CREATE TABLE `baiduimagebed`  (
  `id` int(0) UNSIGNED NOT NULL AUTO_INCREMENT,
  `name` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `keyword` varchar(150) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of baiduimagebed
-- ----------------------------
INSERT INTO `baiduimagebed` VALUES (4, '中国石油大学', '116.253981,40.224412');
INSERT INTO `baiduimagebed` VALUES (5, '润洁公寓', '116.247972,40.219962');
...
CREATE TABLE `chart`  (
  `id` int(0) UNSIGNED NOT NULL AUTO_INCREMENT,
  `datax` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `datay` int(0) UNSIGNED NOT NULL,
  `temp` int(0) NOT NULL,
  PRIMARY KEY (`id`) USING BTREE
...
-- Records of chart
-- ----------------------------
INSERT INTO `chart` VALUES (1, '2019-3', 233, 10);
INSERT INTO `chart` VALUES (2, '2019-5', 2333, 79);
INSERT INTO `chart` VALUES (3, '2019-7', 1333, 56);
INSERT INTO `chart` VALUES (4, '2019-10', 2700, 83);
INSERT INTO `chart` VALUES (5, '2020-02', 1729, 65);
INSERT INTO `chart` VALUES (6, '2020-06', 2107, 73);
INSERT INTO `chart` VALUES (7, '2020-12', 1900, 68);
...
-- Records of employee
-- ----------------------------
INSERT INTO `employee` VALUES (1, '江南一点雨', '男', '1990-01-01', '《油气储运环节分析及优化措施研究》', '已婚', 1, '陕西', 13, 'laowang@qq.com', '18565558897', '深圳市南山区', 5, 9, 29, '劳务合同', '本科', '信息管理与信息系统', '深圳大学', '2018-01-01', '在职', '00000001', 2, '2018-04-01', NULL, '2018-01-01', '2020-01-01', NULL);
...
-- ----------------------------
INSERT INTO `equipment` VALUES (1, '发动机', '进站区', '400*200');
INSERT INTO `equipment` VALUES (2, '油管', '出站区', '500*700');
INSERT INTO `equipment` VALUES (3, '轮胎', '计量区', '300*600');
INSERT INTO `equipment` VALUES (4, '方向盘', '过滤区', '200*200');
INSERT INTO `equipment` VALUES (5, '2', '调压区', '2');
INSERT INTO `equipment` VALUES (10, '车灯', '进站区', '600*600');
INSERT INTO `equipment` VALUES (12, '22', '出站区', '11');
INSERT INTO `equipment` VALUES (16, 'gg', '计量区', 'gg');
INSERT INTO `equipment` VALUES (17, 'gg', '计量区', 'hh');
INSERT INTO `equipment` VALUES (19, '11', '调压区', 'hhh');
...
-- ----------------------------
INSERT INTO `flyway_schema_history` VALUES (1, '1', 'vhr', 'SQL', 'V1__vhr.sql', -1039138481, 'root', '2022-02-24 14:44:31', 1259, 1);
...
-- Records of imagebed
-- ----------------------------
INSERT INTO `imagebed` VALUES (2, '王老师', 'https://s2.loli.net/2022/02/27/b9YQiL6l8dhqaA3.jpg');
INSERT INTO `imagebed` VALUES (3, '王老师好帅啊', 'https://s2.loli.net/2022/02/27/XGpWg9vQ3z1sCrx.jpg');
...
INSERT INTO `menu` VALUES (29, '/', '/home', 'Home', '地图管理', 'fa fa-map', NULL, 1, 1, 1);
INSERT INTO `menu` VALUES (30, '/map/manage/**', '/map/manage/', 'map', '地图图片管理', NULL, NULL, 1, 29, 1);
INSERT INTO `menu` VALUES (31, '/map/map3d/**', '/map/map3d', 'map3d', '3D地图管理', NULL, NULL, 1, 29, 1);
INSERT INTO `menu` VALUES (32, '/', '/home', 'Home', '资料管理', 'fa fa-book', NULL, 1, 1, 1);
INSERT INTO `menu` VALUES (33, '/res/manage/**', '/res/manage', 'ResManage', '资源管理', NULL, NULL, 1, 32, 1);
INSERT INTO `menu` VALUES (34, '/', '/home', 'Home', '数据监控', 'fa fa-line-chart', NULL, 1, 1, 1);
INSERT INTO `menu` VALUES (35, '/time/chart/**', '/time/chart', 'TimeChart', '数据监控', NULL, NULL, 1, 34, 1);
INSERT INTO `menu` VALUES (36, '/time/chartdata/**', '/time/chartdata', 'TimeData', '监控数据添加', NULL, NULL, 1, 34, 1);
INSERT INTO `menu` VALUES (37, '/', '/home', 'Home', '设备管理', 'fa fa-gears', NULL, 1, 1, 1);
INSERT INTO `menu` VALUES (38, '/equip/equip/**', '/equip/equip', 'equip', '设备管理', NULL, NULL, 1, 37, 1);
INSERT INTO `menu` VALUES (39, '/', '/home', 'Home', '用户管理', 'fa fa-user-circle', NULL, 1, 1, 1);
INSERT INTO `menu` VALUES (40, '/user/manage/**', '/user/manage/', 'UserManage', '用户管理', NULL, NULL, 1, 39, 1);
INSERT INTO `menu` VALUES (41, '/map/mappoi/**', '/map/mappoi', 'mappoi', 'Poi拾取', NULL, NULL, 1, 29, 1);
...
INSERT INTO `menu_role` VALUES (284, 31, 6);
INSERT INTO `menu_role` VALUES (285, 33, 6);
INSERT INTO `menu_role` VALUES (286, 35, 6);
INSERT INTO `menu_role` VALUES (287, 36, 6);
INSERT INTO `menu_role` VALUES (288, 38, 6);
INSERT INTO `menu_role` VALUES (289, 40, 6);
INSERT INTO `menu_role` VALUES (290, 41, 6);
...
-- ----------------------------
-- Table structure for resbed
-- ----------------------------
DROP TABLE IF EXISTS `resbed`;
CREATE TABLE `resbed`  (
  `id` int(0) UNSIGNED NOT NULL AUTO_INCREMENT,
  `name` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `url` varchar(150) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
-- Records of resbed
-- ----------------------------
INSERT INTO `resbed` VALUES (1, '《油气储运环节分析及优化措施研究》', 'http://localhost:8080/油气储运环节分析及优化措施研究.pdf');
INSERT INTO `resbed` VALUES (2, '《油气长输管道设备管理与维护措施分析》', 'http://localhost:8080/油气长输管道设备管理与维护措施分析.pdf');
INSERT INTO `resbed` VALUES (3, '《PDF文档表格信息的识别与提取_田翠华》', 'http://localhost:8080/PDF文档表格信息的识别与提取_田翠华.pdf');
INSERT INTO `resbed` VALUES (4, '《一种规则与SVM结合的论文抽取方法_李雪驹》', 'http://localhost:8080/一种规则与SVM结合的论文抽取方法_李雪驹.pdf');
INSERT INTO `resbed` VALUES (5, '《基于PDFBox抽取学术论文信息的实现_牛永洁》', 'http://localhost:8080/基于PDFBox抽取学术论文信息的实现_牛永洁.pdf');
INSERT INTO `resbed` VALUES (6, '《基于WebGIS的地图发布系统—以山西省煤炭资源为例》', 'http://localhost:8080/基于WebGIS的地图发布系统—以山西省煤炭资源为例.pdf');
INSERT INTO `resbed` VALUES (7, '《基于学术论文全文的研究方法句自动抽取研究_张颖怡》', 'http://localhost:8080/基于学术论文全文的研究方法句自动抽取研究_张颖怡.pdf');
INSERT INTO `resbed` VALUES (8, '《基于语义文本图的论文摘要关键词抽取算法_王晓宇》', 'http://localhost:8080/基于语义文本图的论文摘要关键词抽取算法_王晓宇.pdf');
INSERT INTO `resbed` VALUES (9, '《学术论文大纲中关键术语抽取方法研究_何远标》', 'http://localhost:8080/学术论文大纲中关键术语抽取方法研究_何远标.pdf');
INSERT INTO `resbed` VALUES (10, '《服务于科技大数据情报分析的方法及工具研究_曾文》', 'http://localhost:8080/服务于科技大数据情报分析的方法及工具研究_曾文.pdf');
INSERT INTO `resbed` VALUES (11, '《科技大数据的情报分析技术研究_曾文》', 'http://localhost:8080/科技大数据的情报分析技术研究_曾文.pdf');
INSERT INTO `resbed` VALUES (12, '《科技论文中学术信息的提取方法综述_胡志刚》', 'http://localhost:8080/科技论文中学术信息的提取方法综述_胡志刚.pdf');
INSERT INTO `resbed` VALUES (13, '《基于Web的地图服务器的设计与实现_李原野》', 'http://localhost:8080/基于Web的地图服务器的设计与实现_李原野.caj');
